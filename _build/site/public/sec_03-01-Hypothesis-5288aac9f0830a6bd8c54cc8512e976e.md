...
- __The risk of being wrong to reject $H_0$__

**Statistical Significance**:
- When the p-value is less than the chosen significance level ($\alpha$), we __reject the null hypothesis__ and conclude that the results are statistically significant, __supporting the alternative hypothesis__.
