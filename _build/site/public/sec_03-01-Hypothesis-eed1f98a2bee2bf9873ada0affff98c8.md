...
- When the p-value is less than the chosen significance level ($\alpha$), we .red[reject the null hypothesis] and conclude that the results are statistically significant, .red[supporting the alternative hypothesis].
