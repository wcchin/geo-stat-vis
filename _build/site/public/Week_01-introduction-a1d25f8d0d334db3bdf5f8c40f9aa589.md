...
A **thematic map** (e.g., John Snow's map at [](#choleramap) and urban movement map) is a visual representation of a specific theme, subject, or data attribute that emphasizes .red.bold[spatial patterns], relationships, or trends within a geographical area.
