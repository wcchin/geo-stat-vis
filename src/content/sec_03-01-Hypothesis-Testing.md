...
- __The risk of being wrong to reject $\text{H}_0$__

**Statistical Significance**:
- When the p-value is less than the chosen significance level ($\alpha$), we __reject the null hypothesis__ and conclude that the results are statistically significant, __supporting the alternative hypothesis ($\text{H}_1$)__.
- __Otherwise, we fail to reject it__.
...
Hypothesis for testing differences __between two means__:
$$\begin{align}
\text{H}_0 &: \mu_0 = \mu_1 \\\\
\text{H}_1 &: \mu_0 \neq \mu_1
\end{align}$$
...
Hypothesis for testing differences __between more than two means__:
$$\begin{align}
